// -*- C++ -*-
//
// Package:    DelauIdeal/Moge_highPtID_Data
// Class:      Moge_highPtID_Data
// 
/**\class Moge_highPtID_Data Moge_highPtID_Data.cc DelauIdeal/Moge_highPtID_Data/plugins/Moge_highPtID_Data.cc
...
class Moge_highPtID_Data : public edm::EDAnalyzer {
   public:
      explicit Moge_highPtID_Data(const edm::ParameterSet&);
      ~Moge_highPtID_Data();
...
//
Moge_highPtID_Data::Moge_highPtID_Data(const edm::ParameterSet& iConfig):
...
Moge_highPtID_Data::~Moge_highPtID_Data()
{
...
void
Moge_highPtID_Data::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  clearTree();
...
void 
Moge_highPtID_Data::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
...
void 
Moge_highPtID_Data::endRun(edm::Run const&, edm::EventSetup const&)
{
}
...
void 
Moge_highPtID_Data::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
...
void 
Moge_highPtID_Data::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
...
void
Moge_highPtID_Data::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
void Moge_highPtID_Data::clearTree() {
  /*|-------------------------------------------------------|
    |                Run Info Part                           |
    |-------------------------------------------------------|*/     
	Run = -999;
...
DEFINE_FWK_MODULE(Moge_highPtID_Data);

bool Moge_highPtID_Data::isPassHLT(){ 
  int nbMatch = 0;
...
bool Moge_highPtID_Data::RecoHLTMuonMatching(float RecoEta,float RecoPhi){
  int nbMatch  = 0;
  float deltaR = -10000.0;
   //std::cout<<" HLTObj_nbObj = "<< HLTObj_nbObj.size() << endl;
	
  for(unsigned i=0; i<HLTObj_nbObj.size(); i++){
    if( HLTObj_collection[i] == "HLT_IsoMu20_v*" || 
		HLTObj_collection[i] == "HLT_IsoTkMu20_v*"){
...
float Moge_highPtID_Data::delR(float eta1,float phi1,float eta2,float phi2){
	float mpi=3.14;
